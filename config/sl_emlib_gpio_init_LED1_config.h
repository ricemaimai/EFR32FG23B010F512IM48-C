#ifndef SL_EMLIB_GPIO_INIT_LED1_CONFIG_H
#define SL_EMLIB_GPIO_INIT_LED1_CONFIG_H

// <<< Use Configuration Wizard in Context Menu >>>

// <h>Pin settings

// <o SL_EMLIB_GPIO_INIT_LED1_MODE> Pin mode
...
#define SL_EMLIB_GPIO_INIT_LED1_MODE        gpioModeWiredAnd

// <o SL_EMLIB_GPIO_INIT_LED1_DOUT> DOUT <0-1>
...
// <i> Default: 0
#define SL_EMLIB_GPIO_INIT_LED1_DOUT        0
...
// <gpio> SL_EMLIB_GPIO_INIT_LED1
// $[GPIO_SL_EMLIB_GPIO_INIT_LED1]
#ifndef SL_EMLIB_GPIO_INIT_LED1_PORT            
#define SL_EMLIB_GPIO_INIT_LED1_PORT             gpioPortD
#endif
#ifndef SL_EMLIB_GPIO_INIT_LED1_PIN             
#define SL_EMLIB_GPIO_INIT_LED1_PIN              0
#endif
// [GPIO_SL_EMLIB_GPIO_INIT_LED1]$

// <<< sl:end pin_tool >>>

#endif // SL_EMLIB_GPIO_INIT_LED1_CONFIG_H
