#ifndef SL_EMLIB_GPIO_INIT_LED2_CONFIG_H
#define SL_EMLIB_GPIO_INIT_LED2_CONFIG_H

// <<< Use Configuration Wizard in Context Menu >>>

// <h>Pin settings

// <o SL_EMLIB_GPIO_INIT_LED2_MODE> Pin mode
...
#define SL_EMLIB_GPIO_INIT_LED2_MODE        gpioModeWiredAnd

// <o SL_EMLIB_GPIO_INIT_LED2_DOUT> DOUT <0-1>
...
// <i> Default: 0
#define SL_EMLIB_GPIO_INIT_LED2_DOUT        0
...
// <gpio> SL_EMLIB_GPIO_INIT_LED2
// $[GPIO_SL_EMLIB_GPIO_INIT_LED2]
#ifndef SL_EMLIB_GPIO_INIT_LED2_PORT            
#define SL_EMLIB_GPIO_INIT_LED2_PORT             gpioPortD
#endif
#ifndef SL_EMLIB_GPIO_INIT_LED2_PIN             
#define SL_EMLIB_GPIO_INIT_LED2_PIN              1
#endif
// [GPIO_SL_EMLIB_GPIO_INIT_LED2]$

// <<< sl:end pin_tool >>>

#endif // SL_EMLIB_GPIO_INIT_LED2_CONFIG_H
